...
sealed interface Instruction {
    ...
    data class Mov(
        ...
        val arg1: @ArgumentType(
            Register::class, Immediate32::class, ImmediateFloat32::class, Pointer::class,
            Label::class
        ) InstructionArgument,
    ) : Instruction
    ...
    data class In(
        val target: @ArgumentType(Register::class) InstructionArgument,
        val ioPortAddress: @ArgumentType(
            Register::class,
            Immediate32::class,
            ImmediateFloat32::class
        ) InstructionArgument
    ) : Instruction
...
fun Instruction.Companion.identifyInstruction(
    opcode: UByte,
    typeInformation: UByte
): Pair<InstructionEnum, Array<InstructionArgumentEnum>> {
