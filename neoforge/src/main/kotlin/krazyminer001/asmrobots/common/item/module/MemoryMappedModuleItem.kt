...
abstract class MemoryMappedModuleItem(properties: Properties) : ModuleItem(properties) {
    ...
    abstract fun setMappedMemory(identifier: Int, address: Int, itemStack: ItemStack, robotEntity: RobotEntity, value: Byte)

    fun getMap(identifier: Int, itemStack: ItemStack, robotEntity: RobotEntity) = MappedMemory(identifier, itemStack, robotEntity)
    ...
    inner class MappedMemory(val identifier: Int, val itemStack: ItemStack, val robotEntity: RobotEntity) {
        ...
        operator fun set(address: Int, value: Byte) = setMappedMemory(identifier, address, itemStack, robotEntity, value)
    }
}